...
const DEFAULT_PROMPT_1 = "What did you assume that turned out to be wrong?";
const DEFAULT_PROMPT_2 = "Where does that same assumption show up in how we work?";

type SessionReflectionViewProps = {
  prompt1?: string;
  prompt2?: string;
};
